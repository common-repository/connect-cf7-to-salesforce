...
class StandardObjectApi extends SalesforceApi {
	...
	/**
	 * Updates a lead with the given information.
	 *
	 * @param array $leadToUpdate an array containing
	 */
	public function updateLead( string $id, array $leadToUpdate ): array {
		return $this->updateRecord( StandardObjects::Lead, $id, $leadToUpdate );
	}
